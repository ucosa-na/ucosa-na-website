  ...
  try {
    ...
    const { rows } = await pool.query(`
      INSERT INTO member_fund_applications (
        ...
        ben1_name, ben1_sex, ben1_birth_date, ben1_relation, ben1_ssn_last4, ben1_phone, ben1_email,
        has_dependent,
        dep_name, dep_sex, dep_birth_date, dep_commencement_date, dep_ssn_last4,
        dep_street_address, dep_city, dep_state, dep_zip, dep_email,
        dep_alt_address, dep_alt_city, dep_alt_state, dep_alt_zip, dep_alt_phone, dep_alt_email,
        dep_ben_name, dep_ben_sex, dep_ben_birth_date, dep_ben_relation, dep_ben_ssn_last4, dep_ben_phone, dep_ben_email,
      ...
      [
        ...
        f.ben1_name || null, f.ben1_sex || null, f.ben1_birth_date || null, f.ben1_relation || null,
        f.ben1_ssn_last4 || null, f.ben1_phone || null, f.ben1_email || null,
        f.has_dependent || false,
        f.dep_name || null, f.dep_sex || null, f.dep_birth_date || null, f.dep_commencement_date || null, f.dep_ssn_last4 || null,
        f.dep_street_address || null, f.dep_city || null, f.dep_state || null, f.dep_zip || null, f.dep_email || null,
        f.dep_alt_address || null, f.dep_alt_city || null, f.dep_alt_state || null, f.dep_alt_zip || null,
        f.dep_alt_phone || null, f.dep_alt_email || null,
        f.dep_ben_name || null, f.dep_ben_sex || null, f.dep_ben_birth_date || null, f.dep_ben_relation || null,
        f.dep_ben_ssn_last4 || null, f.dep_ben_phone || null, f.dep_ben_email || null,
        ...
        if (fin.email) {
          sendEmail({
            ...
            html: `<div style="font-family:Arial,sans-serif;max-width:520px;margin:auto;border-radius:12px;overflow:hidden;border:1px solid #e8d9c0">
                     ...
                     <div style="background:#f9f9f9;padding:32px">
                       <p>Dear ${fin.full_name || 'Financial Secretary'},</p>
  ...
  try {
    ...
    const { rows } = await pool.query(`
      UPDATE member_fund_applications SET
        ...
        ben1_name=$18, ben1_sex=$19, ben1_birth_date=$20, ben1_relation=$21, ben1_ssn_last4=$22, ben1_phone=$23, ben1_email=$24,
        has_dependent=$25,
        dep_name=$26, dep_sex=$27, dep_birth_date=$28, dep_commencement_date=$29, dep_ssn_last4=$30,
        dep_street_address=$31, dep_city=$32, dep_state=$33, dep_zip=$34, dep_email=$35,
        dep_alt_address=$36, dep_alt_city=$37, dep_alt_state=$38, dep_alt_zip=$39, dep_alt_phone=$40, dep_alt_email=$41,
        dep_ben_name=$42, dep_ben_sex=$43, dep_ben_birth_date=$44, dep_ben_relation=$45, dep_ben_ssn_last4=$46, dep_ben_phone=$47, dep_ben_email=$48,
        terms_accepted=$49, applicant_signature=$50, signature_date=$51,
        president_name=$52, president_signature=$53, president_date=$54,
        status='pending',
